// LEARNING JOURNEY: Withdraw Instruction Step-by-Step
...
pub fn _withdraw(ctx: Context<WithdrawContext>) -> Result<()> {
    // Step 1: Extract accounts for easy access
    ...
    // Step 2: Create CPI context for withdrawal
    ...
    // Step 3: Execute the withdrawal operation
